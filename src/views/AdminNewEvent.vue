        ...
        <div class="full-height" v-if="!isEdit() || !invalidID">
            ...
            <div class="new-event-form full-height">
                <md-field :class="titleInvalid">
                    ...
                    <label>事件标题</label>
                    <md-input type="text" v-model="title" maxlength="10" required />
                    <span class="md-helper-text">不能超过 10 字。</span>
                ...
                <md-dialog :md-active.sync="deleteConfirmDialog">
                    ...
                    <md-dialog-actions>
                        <md-button
                            @click="deleteEvent(); deleteConfirmDialog = false"
                            class="md-primary"
                        >确认删除</md-button>
                        <md-button
                ...
                <md-dialog :md-active.sync="routerConfirmDialog">
                    ...
                    <md-dialog-actions>
                        <md-button
                            @click="next(); routerConfirmDialog = false"
                            class="md-primary"
                        >跳转</md-button>
                        <md-button
                            @click="routerConfirmDialog = false"
                            class="md-primary md-raised"
                        >取消</md-button>
                    </md-dialog-actions>
                </md-dialog>
...
export default Vue.extend({
    ...
    mounted() {
        ...
        window.onbeforeunload = e => {
            if (
                (this.$route.name === "admin-new-event" ||
                    this.$route.name === "admin-edit-event") &&
